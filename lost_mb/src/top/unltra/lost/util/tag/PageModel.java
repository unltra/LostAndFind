...
public class PageModel {
	...
	/** 每页分多少条数据   */
	private int pageSize = LostConstants.PAGE_DEFAULT_SIZE = 10;
	...
	public int getPageSize() {
		this.pageSize = this.pageSize <= LostConstants.PAGE_DEFAULT_SIZE?LostConstants.PAGE_DEFAULT_SIZE:this.pageSize;
		return pageSize;
	}
