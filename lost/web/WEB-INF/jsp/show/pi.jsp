...
<body>
    ...
    <div class="row clearfix">
                            ...
                            <c:forEach items="${requestScope.picks}" var="pick"
                                ...
                                <li class="media">
                                    <a class="media-left" href="#">
                                        <img class="media-object img-rounded thumbnail" src="${ctx}/upload/${pick.ppic }"
                                             alt="通用的占位符图像" height="120px;" width="160px">
                                    </a>
                                    <div class="media-body" height="100px;">
                                        <h4><strong><a href="#" class="item-title">${pick.pname }</a></strong></h4>   
                                        <p>
                                        <span class="gray">编号(ID)：</span>PK${pick.pid}<br>
                                        <span class="gray">拾获地点：</span>${pick.pplace }<br>
                                        <span class="gray">描&nbsp;&nbsp;述：</span>${pick.pdescri }
                                        </p>
                                        <i class="icon-calendar" title="date"></i> <a href="#">3 天前发布</a>
                                      <i class="icon-briefcase" title="ptime" >拾获时间：</i><f:formatDate value="${pick.ptime}" type="date"
									dateStyle="long" />
      ...
      <div class="row-fluid">
           ...
           <div class="well">
            <h4>搜索站内</h4>
            <form name="search_form" action="${ctx}/showPick" method="post">
            <div class="input-group">
              <input type="text" class="form-control" name="pname" id="pname" height="20px">
          ...
          <div class="well sidebar-nav">
            <ul class="nav nav-list">
              <li class="nav-header">查询并浏览拾物</li>
		...
		<p valign="top">
			...
			<topunltra:pager
					...
					submitUrl="${ctx}/showPick?pageIndex={0}" /></p>
		</p>
