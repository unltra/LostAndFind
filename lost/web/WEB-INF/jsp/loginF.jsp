...
<link rel="shortcut icon" href="unltra.ico" />
	...
	<div class="page-lock">
		<div class="page-logo" style="margin-bottom: 2px">
			<a class="brand" href="login.html"
				style="font-size: 22px; color: #FFF;">unltra <font color="#FFCC00">NitLost</font><span
		...
		<form action="login" method="post" id="loginForm">
						...
						<div class="controls">
							<div class="input-icon left">
								<i class="icon-user"></i> <input
									...
									id="aname" name="aname" value="${aname}">
							</div>
						</div>
					</div>
					<div class="control-group">
						<div class="controls">
							<div class="input-icon left">
								<i class="icon-lock"></i> <input
									...
									placeholder="密码" id="apw" name="apw"
									value="${apw}">
							</div>
						</div>
					</div>
			...
			<div class="page-footer" style="color: #fff">
				兼容浏览器IE8+，最佳分辨率1280*800. <br>2015 @ unltra http://www.unltra.top
			</div>
		</form>
	</div>
